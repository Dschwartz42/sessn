...
// SDK 54 moved the classic file-system API (cacheDirectory, downloadAsync) to the
// `/legacy` entry point; the default export is the new File/Directory API.
...
const styles = StyleSheet.create({
  ...
  optionLabel: { color: colors.text, fontFamily: 'Barlow_500Medium', fontSize: 15 },
  cancelBtn: {
    margin: spacing.md,
    paddingVertical: 14,
  ...
  cancelText: { color: colors.text, fontFamily: 'Barlow_600SemiBold', fontSize: 15 },
});
