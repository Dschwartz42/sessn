...
const styles = StyleSheet.create({
  ...
  changePicText: { color: colors.primaryLight, fontFamily: 'Barlow_600SemiBold', fontSize: 15 },
  sectionHeader: {
  ...
  field: { gap: 6 },
  fieldLabel: { color: colors.textSecondary, fontFamily: 'Barlow_500Medium', fontSize: 13 },
  input: {
  ...
  saveBtnText: { color: '#fff', fontFamily: 'Barlow_700Bold', fontSize: 15 },
});
