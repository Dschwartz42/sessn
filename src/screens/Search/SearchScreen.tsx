...
const styles = StyleSheet.create({
  ...
  sectionTitle: { ...typography.h3, paddingHorizontal: spacing.md, paddingBottom: spacing.sm },
  popularPost: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: spacing.md,
  ...
  popularPostImage: { width: 60, height: 60, borderRadius: radius.sm, resizeMode: 'cover' },
  noImage: { backgroundColor: colors.surfaceElevated },
  popularPostInfo: { flex: 1 },
  popularPostTitle: { color: colors.text, fontWeight: '600', fontSize: 15 },
  popularPostStat: { color: colors.textSecondary, fontSize: 13 },
  userRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: spacing.md,
  ...
  displayName: { color: colors.textSecondary, fontSize: 13 },
  followBtn: {
  ...
  followingBtn: { backgroundColor: colors.surfaceElevated, borderWidth: 1, borderColor: colors.border },
  followBtnText: { color: colors.text, fontSize: 13, fontWeight: '600' },
});
