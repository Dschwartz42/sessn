  ...
  const handlePost = async () => {
    ...
    try {
      ...
      const postData: Omit<Post, 'id' | 'likeCount' | 'repostCount' | 'saveCount' | 'createdAt'> = {
        ...
        exercises: (postType === 'independent' && selectedTypes.includes('Lifting') ? exercises : null) as any,
...
const styles = StyleSheet.create({
  ...
  typeBtn: { flex: 1, paddingVertical: 9, borderRadius: radius.pill, alignItems: 'center' },
  typeBtnActive: { backgroundColor: colors.primary },
  typeBtnText: { color: colors.textSecondary, fontFamily: 'Barlow_600SemiBold', fontSize: 14 },
  ...
  locationBtnText: { color: colors.text, fontFamily: 'Barlow_400Regular', fontSize: 15 },
  ...
  photoText: { color: colors.textDim, fontFamily: 'Barlow_400Regular', fontSize: 15 },
  nextBtn: {
  ...
  nextBtnText: { color: '#fff', fontFamily: 'Barlow_700Bold', fontSize: 16 },
  exerciseCard: {
